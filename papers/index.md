...
type: Index
title: 논문 모음 (Papers)
description: 그래프 표현학습/GNN의 기반 논문 13편을 4개 주제로 분류한 concept 모음. ⭐ = 탑티어 AI 학회 필독.
tags: [papers, index, gnn, graph-representation-learning, must-read]
...
그래프 표현학습·GNN의 **기반(landmark) 논문 13편** 입니다. 각 논문은 `문제 → 방법 → 기여 → 결과 → 링크`
양식의 concept 문서입니다.
...
| 주제 | 논문 수 | ⭐ 필독 | 바로가기 |
|------|:------:|:------:|----------|
| 📐 기초 (랜덤워크·GNN 백본) | 5 | 5 | [foundations/index.md](foundations/index.md) |
